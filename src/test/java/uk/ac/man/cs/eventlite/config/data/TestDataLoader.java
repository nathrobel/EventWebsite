	...
	CommandLineRunner initDatabase() {
		return args -> {
			if (venueService.count() > 0) {
				...
				new_venue.setName("Test");
				new_venue.setCapacity(100);
				new_venue.setPostcode("M13 9BS");
				new_venue.setRoadName("Oxford Road");
				venueService.save(new_venue);

				Venue new_venue2 = new Venue();
				new_venue2.setName("Kilburn");
				new_venue2.setCapacity(300);
				new_venue2.setPostcode("M9 9DS");
				new_venue2.setRoadName("Victoria Road");
				venueService.save(new_venue2);
				Venue new_venue3 = new Venue();
				new_venue3.setName("Eng A");
				new_venue3.setCapacity(1000);
				new_venue3.setPostcode("M1 3BA");
				new_venue3.setRoadName("Chester Road");
				venueService.save(new_venue3);
